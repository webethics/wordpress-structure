...
<? if(isset($_GET['assignments'])){ ?>
	<form method="post">
		...
		<input type="hidden" name="postid" value="<? echo $_GET['prod_id'];?>">
		<input type="hidden" name="commentparent" value="<? echo $_GET['assignments'];?>">
        ...
        <table class="tutor-dashboard-info-table">
            <tbody>
				...
				<tr>
					...
					<td><a href="/my-account/my-assignments/?id=<? echo $result->comment_ID; ?>">View</a></td>
