            ...
            <div class="container-wrap">
               <div class="row-wrap">
				  ...
				  <div class="pd-details-wrap">
					...
					<p><? echo $excerpt; ?></p>
					<p><? if($coming == "coming"){echo '<div class="elementor-widget-container">
									<h4 class="elementor-heading-title elementor-size-default"><p style="color:#25A9E0;">Coming Soon!</p></h4>	
						</div>';} else { echo $class; } ?></p>
					<? if($hideclass != "hide"){ ?><p> <a class="elementor-button-link elementor-button elementor-size-xs" href="#liveclass">View all classes</a></p><? } ?>
					<p class="grade-wrap">Grade: <? echo $grade; ?>  | Instructor Name: <? echo $full_name; ?>	</p>
				   <p class="category-wrap">Category: <? echo $category; ?> | Type: <? echo $type; ?>&nbsp;</p>
				   <? if($finalcount > 0 && $late_enroll == "yes"){ ?><div class="required"><? echo $finalcount." Class(es) passed!"; ?></div> <? } ?>
				   <div class="price-wrap courseprice">Price: <? echo $finalprice; ?></div>
				   <? if($hideclass != "hide"){ if (current_user_can(tutor()->instructor_role)){ } elseif(in_array( 'customer', (array) $user->roles )){ echo do_shortcode('[elementor-template id="11436"]'); ?> <div class="btn-wrap"><button class="tutor-btn-enroll user-enroll-popup tutor-btn tutor-course-purchase-btn buy-btn"> Enroll Now </button></div> <? } else{ ?><div class="btn-wrap"><? tutor_single_course_add_to_cart(); ?></div><? } }elseif($finalcount <= $late_enroll_data && $late_enroll == "yes" && $countmain > 0){if (current_user_can(tutor()->instructor_role)){ } elseif(in_array( 'customer', (array) $user->roles )){ echo do_shortcode('[elementor-template id="11436"]'); ?> <div class="btn-wrap"><button class="tutor-btn-enroll user-enroll-popup tutor-btn tutor-course-purchase-btn buy-btn"> Late Enroll Now </button></div> <? } else{ ?><div class="btn-wrap"><? tutor_single_course_add_to_cart(); ?></div><? }
				   } ?>
               ...
               <div class="row-wrap">
                  <div class="col-wrap">
					 <h4 class="heading-title">Class Lessons</h4>
					  <ul class="listing">
						...
						<li><? echo $tutor_lesson_count; ?> lessons</li>
						<li><? echo $quiz_count; ?> Quizzes</li>
                  ...
                  <div class="col-wrap" id="contentmain">
					  <div class="course-desc-wrap">
						...
						<? if($hideclass != "hide"){ if (current_user_can(tutor()->instructor_role)){ } elseif(in_array( 'customer', (array) $user->roles )){ echo do_shortcode('[elementor-template id="11436"]'); ?> <div class="btn-wrap"><button class="tutor-btn-enroll user-enroll-popup tutor-btn tutor-course-purchase-btn buy-btn"> Enroll Now </button></div> <? } else{ ?><div class="btn-wrap"><? tutor_single_course_add_to_cart(); ?></div><? } } ?>
					  </div>				  
                  </div>
				  ...
				  <ul class="listing">
					...
					<li><strong>All Live Classes: </strong> <? if($late_enroll == "yes"){ echo $finalcount." Class(es) passed!";} ?><br><? echo $class1; ?></li>
