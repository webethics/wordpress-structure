...
<div class="tutor-queston-and-answer-wrap">
    ...
    <div class="tutor-add-question-wrap" style="display: none;">
        <form method="post" id="tutor-ask-question-form">
            ...
            <div class="tutor-form-group">
                <a href="javascript:;" class="tutor_question_cancel tutor-button tutor-danger"><? _e('Cancel', 'tutor'); ?></a>
                <button type="submit" class="tutor-button tutor-success tutor_ask_question_btn" name="tutor_question_search_btn"><? _e('Post Question', 'tutor'); ?> </button>
            </div>
        </form>
    </div>
                    ...
                    <div class="tutor_add_answer_row">
                        <div class="tutor_add_answer_wrap " data-question-id="<? echo $question->comment_ID; ?>">
                            <div class="tutor_wp_editor_show_btn_wrap">
                                <a href="javascript:;" class="tutor_wp_editor_show_btn tutor-button tutor-success"><? _e('Add an answer', 'tutor'); ?></a>
                            </div>
                            <div class="tutor_wp_editor_wrap" style="display: none;">
                                <form method="post" class="tutor-add-answer-form">
                                    ...
                                    <div class="tutor-form-group">
                                        <a href="javascript:;" class="tutor_cancel_wp_editor tutor-button tutor-danger"><? _e('Cancel', 'tutor'); ?></a>
