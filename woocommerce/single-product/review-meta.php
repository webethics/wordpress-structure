...
<? } else { ?>
	...
	<p class="meta">
		<strong class="woocommerce-review__author"><? comment_author(); ?> </strong>
		<?
		...
		?>
		<span class="woocommerce-review__dash">&ndash;</span> <time class="woocommerce-review__published-date" datetime="<? echo esc_attr( get_comment_date( 'c' ) ); ?>"><? echo esc_html( get_comment_date( wc_date_format() ) ); ?></time>
	</p>
